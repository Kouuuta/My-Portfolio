            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 dark:focus:ring-emerald-400"
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 h-full">
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a
                    href="#"
                    className="p-3 bg-gray-100 dark:bg-gray-700 rounded-full hover:bg-emerald-100 dark:hover:bg-emerald-900 transition-colors"
                  >
                    <svg
                      className="h-6 w-6 text-gray-700 dark:text-gray-300 hover:text-emerald-600 dark:hover:text-emerald-400"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                      aria-hidden="true"
                    >
